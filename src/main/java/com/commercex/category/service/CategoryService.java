...
public interface CategoryService {
    ...
    /**
     * Finds Category entities by a set of IDs.
     * Used by ProductServiceImpl to resolve category associations without
     * reaching directly into CategoryRepository (respects SRP and DIP).
     */
